...
.review_top {}
	...
	<form name="input" method="post" action="../re_attr/re_attr.do?m=insert&email=${user.email}">
    ...
    <tr>
        <th colspan="1">제목</th>
        <td colspan="3"><input type="text" name="review_subject" class="input_st inp_w100" /></td>
    </tr>
    <tr>
        <th colspan="1">평점</th>
        <td colspan="3">            
    ...
    <tr>
	  	<td colspan="4" style="padding:0; border:none"><textarea name="review_content" class="input_st tw1"></textarea></td>
	  </tr>
