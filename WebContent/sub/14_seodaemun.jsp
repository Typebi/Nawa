...
<div class="sub_con">
    <div class="lnb_area">
        <div class="box1">
			<ul class="gnb">
				<li class="m_1">
					<a href="../attr/attr.do?m=list&area_no=14" class="dp1">REVIEW<span class="icon"></span></a>
					<ul class="dp2">
           				<li class="sm_1 on"><a href="../attr/attr.do?m=list&area_no=14">REVIEW</a></li>
           			</ul>
				</li>
			</ul>
        </div>
...
<div class="box1">
    ...
    <dl class="rv_list_top">
   		<dt class="rv_list_l"><i class="xi xi-map"></i>서대문구</dt>
   		<dd class="rv_list_r">
		...
		<li>
			<div class="inner">
		        ...
		        <div class="review_mdl_btm2">
					...
					<button type="button" class="search_btn b_btn" onclick="location.href='../attr/attr.do?m=del&attr_seq=${review.attr_seq}&area_no=14'">삭제</button>
	       			</div>
       			</div>
		    </div>
		</li>
