...
<script>
	...
	<form name="input" method="post" action="../Commu/Commu.do?m=insert&email=${user.email}" enctype="multipart/form-data">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="board_st write"  onload="input.subject.focus()">
		  ...
		  <tr> 
		    <th>제목</th>
		    <td><input type="text" class="input_st iw100" name="subject"/></td>
		  </tr>
		  <tr>
		  	<td colspan="2" style="padding:0; border:none"><textarea class="input_st tw1" name="content"></textarea></td>
		  </tr>
		  <tr>
		    <th>파일첨부</th>
		    <td><input type="file" class="input_st iw100" name="fname"/></td>
		  </tr>
