...
<body>
	...
	<div id="header"> 
		...
		$(window).load(function(){
			$(".sub .svisu_area .visu_sgarea").animate({
				paddingTop:110, opacity:1
	...
	<!--header end-->
	<div id="contents" class="contents sub">
		<div class="svisu_area">
		    <div class="svisual" style="width:100%; height:230px;  background:url(../images/s_visu1_bg.jpg) no-repeat center top">
		        <div class="box1">
		            <div class="visu_sgarea">
		                <p class="copy1">NAWA Trip</p>
		                <p class="copy2">Come out and leave now?</p>
		            </div>
		        </div>
		    </div>
		</div>